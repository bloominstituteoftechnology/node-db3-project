...
async function findById(scheme_id) { // EXERCISE B
  ...
  */
      ...
      })//this is to choose what to show if the steps is not [],
      // also scheme name is already shown on top
    return result
}
...
async function findSteps(scheme_id) { // EXERCISE C
  /*
    ...
    //  select 
    //     step_id, step_number, instuctions
    // from schemes as sc
    // left join steps as st
    // on sc.schemes_id =st.schemes_id
    // where sc.scheme_id=1
